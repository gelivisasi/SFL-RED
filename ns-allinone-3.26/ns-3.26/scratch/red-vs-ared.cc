...
int main (int argc, char *argv[])
{
  ...
  clientHelper.SetAttribute ("OnTime", StringValue ("ns3::WeibullRandomVariable[Scale=1.|Shape=4.]"));
  clientHelper.SetAttribute ("OffTime", StringValue ("ns3::WeibullRandomVariable[Scale=1.|Shape=4.]"));
  ...
  std::ostream_iterator<qTimeRed> output_iterator1(output_file1, "\n");
  ...
  std::ostream_iterator<qTimeRed> output_iterator2(output_file2, "\n");
